...
public class DesEncryptionService : IEncryptionService
{
    ...
    public EncryptionAlgorithm Algorithm => EncryptionAlgorithm.DES;

    public async Task<EncryptionResult> EncryptAsync(Stream inputStream, CancellationToken cancellationToken = default)
    {
#pragma warning disable SYSLIB0041 // DES is obsolete - retained for legacy support
...
#pragma warning restore SYSLIB0041
        ...
        using var hmac = new HMACSHA256(des.Key);
